    ...
    $('#openbutton').click(
      function(e) {
        ...
        <tr>
        	...
        	<td width="<?php echo $col2;?>"><?php 
				if($row['status']==1 || $_SESSION['user_level'] >= POWER_LEVEL){
            ...
            <?php 
			if($_SESSION['user_level'] < POWER_LEVEL && !checkView() && $row['status'] !=1){
			?>
      ...
      function(e) {
        ...
        <?php
			...
			foreach($documents as $doc){
				...
				echo '<tr><td colspan="4"><a style="color:#DCB272" href="download.php?file='.$docs.'/'.$doc.'">'.$doc.'</a></td></tr>';
				}
			}
			if(is_dir('rrdocs/'.$id)){
