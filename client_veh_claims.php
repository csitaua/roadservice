...
<html>
<head>
    <title>Nagico Vehicle Claims</title>
    ...
    <table align="center" width="1200" border="0" cellspacing="0" cellpadding="5" class="main" >
        <tr>
            <td width="100%" valign="top">
                ...
                <form action="client_veh_claims_rec.php" enctype="multipart/form-data" method="post" name="genClaims" id="getClaims" >
                    <table align="center" width="65%" border="0" cellpadding="3" cellspacing="3" class="loginform">
                        ...
                        <tr>
                            ...
                            <table width="100%">
                            <tr><td width="45%">
                             <input type="text" id="date_of_loss" name="date_of_loss" readonly value=""/ class="fill_in" size="15">
    ...
    $('#date_of_loss_button').click(
      function(e) {
        ...
        e.preventDefault();
                        ...
                        <tr>
                            <td align="right"  style="font-weight:bold">License Plate</td>
                            <td>&nbsp;<input name="num" type="text" size="15" class="fill_in"></td>
                        </tr>
                        <tr>
                            <td align="right"  style="font-weight:bold">Policy Number</td>
                            <td>&nbsp;<input name="pol" type="text" size="15" class="fill_in"></td>
                        </tr>
                        <tr>
                            <td align="right"  style="font-weight:bold">Vehicle Make and Model</td>
                            <td>
                            <table width="100%">
                            <tr><td width="45%"><input name="car" type="text" size="25" class="fill_in"></td><td width="25%"><b>Vehicle Year</b></td><td><input name="veh_year" type="text" style="width:100%"  class="fill_in"></td></tr></table>
                            </td>
                        </tr>
                        <tr>
                            <td align="right"  style="font-weight:bold">Insured Name</td>
                            <td><table width="100%">
                            <tr><td width="45%"><input name="requestedBy" type="text" size="25" class="fill_in"></td><td width="25%"><b>Phone</b></td><td><input name="addphone" type="text" style="width:100%"  class="fill_in"></td></tr></table>
                            </td>
                        </tr>
                        <tr>
                            <td align="right"  style="font-weight:bold">Insured Email</td>
                            <td><table width="100%">
                            <tr><td width="45%"><input name="contact_info_email" type="text" size="25" class="fill_in"></td><td width="25%"><b>Second Phone</b></td><td><input name="other_contact_phone" type="text" style="width:100%" class="fill_in"></td></tr></table>
                            
                            </td>
                        </tr>
                         <tr>
                            <td align="right"  style="font-weight:bold">Location/Address</td>
                            <td>&nbsp;<input name="loc" type="text" style="width:100%" class="fill_in"></td>
                        </tr>
                         <tr>
                         ...
                         <tr>
                            <td align="right"  style="font-weight:bold" valign="top">Provide details of the loss</td>
                            <td><textarea name="client_note" style="width:100%"  rows="6" class="fill_in"></textarea></td>
                        </tr>
                         <tr>
                            <td align="right"  style="font-weight:bold" valign="bottom">Images</td>
                            <td>
