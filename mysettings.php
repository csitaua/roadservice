...
<div class="myaccount">
  ...
  <a href="./">Agent Calculator Home</a><br>
	...
	if(!empty($err))  {
      ...
      <form action="mysettings.php" method="post" name="myform" id="myform">
        <table width="90%" border="0" align="center" cellpadding="3" cellspacing="3" class="forms">
          <tr>
            <td colspan="2"> Your Name / Company Name<br> <input name="name" disabled type="text" id="name"  class="required" value="<?php echo $row_settings['full_name']; ?>" size="50">
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            <td>Country</td>
            <td><input name="country" type="text" disabled id="country" value="<?php echo $row_settings['country']; ?>" ></td>
          </tr>
          <tr>
            <td width="27%"></td>
            <td width="73%"><input name="tel" style="display:none" type="text" id="tel" class="required" value="<?php echo $row_settings['tel']; ?>">
            <input name="fax" style="display:none" type="text" id="fax" value="<?php echo $row_settings['fax']; ?>">
           <input name="web" style="display:none" type="text" id="web" class="optional defaultInvalid url" value="<?php echo $row_settings['website']; ?>">  </td>
          </tr>
          <tr>
            <td>User Name</td>
