    ...
    $('#openbutton').click(
      function(e) {
        ...
        <tr>
			...
			?></td>
          	<td class="middle-right-child" width="<?php echo $col2;?>"><input  <?php if(strcmp($row['toloc'],'')!=0){ echo $st;}?> type="text" style="background-color:#FAD090; <?php if($row['job'] != 3 && $row['job'] != 12 && $row['job'] != 13 && $row['job'] != 14  && $row['job'] != 16  && $row['job'] != 19  && $row['job'] != 20  && $row['job'] != 22 && $row['job'] != 29 && $row['job'] != 32 && $row['job'] != 33 && $row['job'] != 36){ echo 'display:none'; }?>" name="toloc" id="loc" size="23" value="<?php echo $row['to_location'];?>"/> VII: <input type="checkbox" name="c_add" id="c_add" onchange="copyAddress()"/> 
        ...
        <tr>
         ...
         <tr>
        	<td class="middle-left-child" width="<?php echo $col1;?>">Requested By:</td>
       		<td class="middle-right-child" width="<?php echo $col2;?>"><input type="text" value="<?php echo $row['requestedBy'];?>" style="background-color:#FAD090;" name="requestedBy" id="requestedBy" size="20" maxlength="50"/> VII: <input type="checkbox" name="c_req" id="c_req" onchange="copyName()"/></td>
        ...
        <tr>
        	<td class="middle-left-child" width="<?php echo $col1;?>">Add. Phone:</td>
       		<td class="middle-right-child" width="<?php echo $col2;?>"><input type="text" value="<?php echo $row['AddPhone'];?>" style="background-color:#FAD090;" name="addphone" id="addphone" size="18"/ >  VII: <input type="checkbox" name="c_mob" id="c_mob" onchange="copyPhone()"/></td>
      ...
      function(e) {
        ...
        <?php
			...
			while($row3 = mysql_fetch_array($rs3)){
				...
				?>
                <tr><td class="bottom-child"  colspan="4">&nbsp;</td></tr>
        </tr>
        <tr>
        	...
        	<td colspan="5" cellspacing="0">
            	<table width="100%" cellspacing="0">
                	<tr cellspacing="0">
                    	...
                    	ID: <input type="text" name="accident_id2" maxlength="5" size="8" style="background-color:#FAD090" value="<?php if($row['accident_link2']!=0){echo $row['accident_link2'];}?>"/>
                     ...
                     <td class="middle-full-child" width="14%" valign="top">
                    	...
                    	ID: <input type="text" name="accident_id3" maxlength="5" size="8" style="background-color:#FAD090" value="<?php if($row['accident_link3']!=0){echo $row['accident_link3'];}?>"/>
                        ...
                        <td class="right-child" width="14%" valign="top">
                        	<div class="buttonwrapper"><a class="squarebutton" style="font-size:14px; font-weight:bold" href="edit_sc.php?sc=<?php echo $id;?>&message=1"><span>Send Message</span></a>
				</div>
                        </td>
                    </tr>
                </table>
