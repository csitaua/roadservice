...
function adminMenu(){
	...
	<div class="min-h-screen bg-gray-100 p-4 mx-auto w-9/12">
	<nav class="relative flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-'.MENU_ADMIN_BG_COLOR.' mb-3 rounded">
	<div class="p-1">

		<div class="dropdown inline-block relative">
	    <button class="bg-'.MENU_ADMIN_BG_COLOR.' text-gray-50 font-semibold px-2 rounded inline-flex items-center">
	      <span class="mr-1"><a href="/">Home</a></span>
	    </button>
	  </div>
		...
		<div class="dropdown inline-block relative">
			<button class="bg-'.MENU_ADMIN_BG_COLOR.' text-gray-50 font-semibold px-2 rounded inline-flex items-center">
				<span class="mr-1">Admin Panels</span>
				<svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/> </svg>
			</button>
			<ul class="dropdown-menu absolute hidden text-gray-50 pt-1">
				<li class=""><a class="rounded-t bg-'.MENU_ADMIN_BG_COLOR.' hover:bg-'.MENU_ADMIN_BG_COLOR1.' py-2 px-4 block whitespace-no-wrap" href="admin.php">User</a></li>
				<li class=""><a class=" bg-'.MENU_ADMIN_BG_COLOR.' hover:bg-'.MENU_ADMIN_BG_COLOR1.' py-2 px-4 block whitespace-no-wrap" href="admin_adjusters.php">Adjuster</a></li>
				<li class=""><a class=" bg-'.MENU_ADMIN_BG_COLOR.' hover:bg-'.MENU_ADMIN_BG_COLOR1.' py-2 px-4 block whitespace-no-wrap" href="admin_attendees.php">Attendee</a></li>
				<li class=""><a class=" bg-'.MENU_ADMIN_BG_COLOR.' hover:bg-'.MENU_ADMIN_BG_COLOR1.' py-2 px-4 block whitespace-no-wrap" href="admin_rentalclaims.php">Rental/Claim Person</a></li>
				<li class=""><a class="rounded-b bg-'.MENU_ADMIN_BG_COLOR.' hover:bg-'.MENU_ADMIN_BG_COLOR1.' py-2 px-4 block whitespace-no-wrap" href="admin_rental_fleet.php">Rental Fleet</a></li>
		</div>
		...
		<div class="dropdown inline-block relative">
			...
			<ul class="dropdown-menu absolute hidden text-gray-50 pt-1">
				<li class=""><a class=" bg-'.MENU_ADMIN_BG_COLOR.' hover:bg-'.MENU_ADMIN_BG_COLOR1.' py-2 px-4 block whitespace-no-wrap" href="adminreports/user.php">User</a></li>
			</ul>
		</div>
